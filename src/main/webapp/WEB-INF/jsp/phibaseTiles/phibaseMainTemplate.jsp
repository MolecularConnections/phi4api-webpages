...
<div class="wrap" style="width:100%">
	<div class="wrapper" style="width:100%">
		<table border="1" style="border-collapse: collapse;  margin: 0 auto;" cellpadding="2" cellspacing="2" align="left" width="100%" height="100%"   class="jtable ui-widget-content">
			<tbody>
			<tr>
		        <td  valign="top" width="100%" style="vertical-align: top; "><tiles:insertAttribute name="header"/></td>
		    </tr>
		    <tr>

		        <td valign="top" width="100%" style="vertical-align: top; background:#dde8f0 ">
