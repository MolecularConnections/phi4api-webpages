...
<div style="width:100%" class="sidebar">
				<div class="menu_box_list">
				      		<ul >
								...
								<li id="sideHead2" style="font-size:20px; padding:5px 10px; ">Version 3.8</li>
								<li style="padding:5px 10px">
								<br />
								<!----- new code dated 4 May,2k115 -->
								<table width="100%" border="1" cellpadding="5" cellspacing="2" bordercolor="#999999" style="border:1px solid #434343;" class="righttable">
								...
								<li id="sideHead2" style="font-size:20px; ">Version 3.7</li>
								<li style="padding:5px 10px;"> 
								<br />
								<!----- new code dated 4 May,2k115 -->
								<table width="100%" border="1" cellpadding="5" cellspacing="2" bordercolor="#999999" style="border:1px solid #434343;" class="righttable">
								...
								<tbody>
									  <tr style="border:1px solid #434343">
										<td width="50%" height="28" align="left" valign="middle" bgcolor="#EAEAEA" style="border:1px solid #434343">
										  Table                        </td>
										<td width="50%" align="left" valign="middle" bgcolor="#EAEAEA" style="border:1px solid #434343">
										  No. of records                        </td>
									  </tr>
									  <tr style="border:1px solid #434343"> <td height="31" align="left" valign="middle" style="border:1px solid #434343">
										  Genes                        </td>
										<td align="left" valign="middle" style="border:1px solid #434343">
										  3369                        </td>
									  </tr>
									  <tr style="border:1px solid #434343"> <td height="32" align="left" valign="middle" style="border:1px solid #434343">
										  Interactions                        </td>
										<td align="left" valign="middle" style="border:1px solid #434343">
										  4792                        </td>
									  </tr>
									  <tr style="border:1px solid #434343"> <td height="34" align="left" valign="middle" style="border:1px solid #434343">
										  Pathogens                        </td>
										<td align="left" valign="middle" style="border:1px solid #434343">
										  225                        </td>
									  </tr>
									  ...
									  <tr style="border:1px solid #434343"> <td height="30" align="left" valign="middle" style="border:1px solid #434343">
										  Diseases                        </td>
										<td align="left" valign="middle" style="border:1px solid #434343">
										  261                        </td>
									  </tr>
						...
						<li id="sideHead2" style="font-size:20px; ">Version 3.6</li>
								<li style="padding:5px 10px;"> 
								<br />
								<!----- new code dated 4 May,2k115 -->
								<table width="100%" border="1" cellpadding="5" cellspacing="2" bordercolor="#999999" style="border:1px solid #434343;" class="righttable">
						...
						<table width="100%" cellpadding="2" cellspacing="0" class="righttable" style="border:1px solid #434343">
								...
								<tbody>
                      <tr style="border:1px solid #434343">
                        <td width="50%" height="31" align="left" valign="middle" bgcolor="#EAEAEA" style="border:1px solid #434343">
                          Table                        </td>
                        <td width="50%" align="left" valign="middle" bgcolor="#EAEAEA" style="border:1px solid #434343">
                          No. of records                        </td>
                      </tr>
                      ...
                      <tr style="border:1px solid #434343"> <td height="33" align="left" valign="middle" style="border:1px solid #434343">
                          Diseases
                        </td>
                        <td align="left" valign="middle" style="border:1px solid #434343">
                          107                        </td>
					...
					<br />
						...
						<tbody>
                      <tr style="border:1px solid #434343">
                        <td height="30" align="left" valign="middle" bgcolor="#EAEAEA" style="border:1px solid #434343">
                          Table                        </td>
                        <td align="left" valign="middle" bgcolor="#EAEAEA" style="border:1px solid #434343">
                          No. of records                        </td>
                      </tr>
                      <tr style="border:1px solid #434343"> <td height="31" align="left" valign="middle" style="border:1px solid #434343">
                          Genes
...
<p style="margin-top:8px"><span style="font-size:14px;">Version 3.8 <span style="font-size:11px; color:#434343">July 1st 2015</span>   </span></p>
<p style="margin-top:8px"><span style="font-size:14px;">Version 3.7 <span style="font-size:11px; color:#434343">May 9th 2015 </span>   </span></p>
<p style="margin:3px 0px"><span style="font-size:14px;">Version 3.6 <span style="font-size:11px; color:#434343">May 6th 2014 </span>   </span></p>
<p style="margin:3px 0px"><span style="font-size:14px;">Version 3.5 <span style="font-size:11px; color:#434343">November 4th 2013</span>   </span></p>
...
<br /><br /> -->
<strong style="font-size: 1.2em; color:#0877D0" id="3.6">Current release </strong>
<br><br>
<strong style="font-size: 1em; color:#0877D0" id="3.6"><strong>Version 4.0</strong> September 30th 2015 </strong>
		
		<p style="margin-top:10px">
			<ul style="list-style-type: disc; list-style-position: inside;">
        		<li style="font-size: 14px;">New website displaying additional information </li>
        		<li style="font-size: 14px;">BLAST tool to compare a user's sequence against PHI-base protein sequences </li>
        		<li style="font-size: 14px;">Increase in genes and annotations </li>
    		</ul>
		</p>
<br />
<!-- 
		<p style="margin-top:10px">
			<ul style="list-style-type: disc; list-style-position: inside;">
        		<li style="font-size: 14px;">Bugfixes and inclusion of additional Oomycete effectors </li>
    		</ul>
		</p>
<br />
